    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action != null) {
            if (intent.action == TOAST_ACTION) {
                ...
                Toast.makeText(context, "Touched vies $viewIndex", Toast.LENGTH_SHORT).show()
            }
        }
    }

    companion object {
        private const val TOAST_ACTION = "app.ditodev.stacko.TOAST_ACTION"
        const val EXTRA_ITEM = "app.ditodev.stacko.EXTRA_ITEM"
